  ...
  return (
    <section className="mx-auto mt-16 max-w-5xl px-4 bg-[#050816]">
      ...
      <p className="text-sm sm:text-base text-zinc-300 mt-2">
        Athletes get daily workouts, streak tracking, and leaderboards to stay
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        {cards.map((c) => (
          <article
            key={c.title}
            className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5 flex flex-col gap-3"
          >
