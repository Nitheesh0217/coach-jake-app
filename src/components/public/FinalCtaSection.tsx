        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-4 px-4 py-10 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm sm:text-base text-zinc-300 mt-1">
              No long-term contracts. Start with a free call and a simple 4-week
              plan.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            <Link
              href="/contact"
              className="inline-flex items-center rounded-full bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-black shadow-lg shadow-emerald-500/30"
            >
              Book a free call
            </Link>
            <Link
