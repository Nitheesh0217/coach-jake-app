...
const PROGRAMS = [
  {
    ...
    cardClass:
      "border-emerald-500/35 bg-gradient-to-br from-emerald-500/[0.07] to-zinc-950 shadow-[0_0_40px_rgba(16,185,129,0.12)]",
    Icon: Zap,
    ...
    level: "Intermediate",
    image:
      "https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=600&q=80&auto=format&fit=crop",
  },
  {
    badge: "STRENGTH",
    badgeClass: "border-cyan-500/50 bg-cyan-500/15 text-cyan-300",
    cardClass:
      "border-zinc-700/50 bg-zinc-900/40 hover:border-zinc-600/70 hover:bg-zinc-900/60",
    Icon: Dumbbell,
  ...
  },
  {
    ...
    level: "All Levels",
    image:
      "https://images.unsplash.com/photo-1608245449230-4ac19066d2d0?w=600&q=80&auto=format&fit=crop",
  },
];
          ...
          >
            ...
            <div className="relative h-44 overflow-hidden bg-zinc-900">
              ...
              <div className="absolute top-3 left-3">
                <span
                  className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-black uppercase tracking-wider ${p.badgeClass}`}
                >
