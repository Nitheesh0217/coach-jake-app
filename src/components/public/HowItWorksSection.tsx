  ...
  return (
    <section className="mx-auto mt-16 max-w-5xl px-4 bg-[#050816]">
      ...
      <p className="text-sm sm:text-base text-zinc-300 mt-2">
        Sign up, get a focused plan, and follow short daily sessions to see
        measurable gains.
      </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        {steps.map((s) => (
          <div
            key={s.label}
            className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5 transition transform duration-250 hover:-translate-y-0.5 hover:border-emerald-500/50"
          >
