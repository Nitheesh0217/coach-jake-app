            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {assigned.map((w, i) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-black text-white mt-3 mb-1">
                    {w.title}
                  </h3>
              ...
              >
                {library.map((w, i) => (
                  ...
                  >
                    ...
                    {w.completed && !w.completedToday && (
                      <div className="absolute top-3 left-3 z-10 flex items-center gap-1.5 text-[10px] font-black text-zinc-500 bg-zinc-700/40 border border-zinc-600/30 px-2 py-0.5 rounded-full">
