...
export default function AppSidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-transparent flex">
      {/* ── SIDEBAR (desktop) ── */}
      <aside className="hidden md:flex md:flex-col md:fixed md:inset-y-0 md:left-0 md:w-[220px] border-r border-zinc-800/60 bg-zinc-950/80 backdrop-blur-md z-40">
        {/* Logo */}
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 bg-zinc-950/90 backdrop-blur-xl border-t border-zinc-800/60 z-50 flex items-center justify-around px-2 py-2">
