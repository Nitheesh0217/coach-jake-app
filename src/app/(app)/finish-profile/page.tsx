  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-transparent">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        {/* Top stickers */}
        <div
          className="absolute top-24 right-12 text-7xl opacity-15 select-none"
          style={{ animation: "float 8s ease-in-out infinite" }}
        >
          🏀
        </div>
        <div
          className="absolute top-40 left-16 text-6xl opacity-12 select-none"
          style={{
        ...
        {/* Middle stickers */}
        <div
          className="absolute top-1/2 right-20 text-5xl opacity-10 select-none"
          style={{
        ...
        <div
          className="absolute top-1/3 left-1/4 text-5xl opacity-10 select-none"
          style={{
        ...
        {/* Bottom stickers */}
        <div
          className="absolute bottom-32 right-1/4 text-6xl opacity-12 select-none"
          style={{
        ...
        <div
          className="absolute bottom-24 left-1/3 text-5xl opacity-10 select-none"
          style={{
        ...
        <div
          className="absolute bottom-1/3 right-1/3 text-4xl opacity-8 select-none"
          style={{
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 50%, rgba(5, 8, 22, 0) 0%, rgba(5, 8, 22, 0.4) 100%)",
        }}
      ></div>
